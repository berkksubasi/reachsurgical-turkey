            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="w-full md:w-1/2 md:pr-12 mb-12 md:mb-0">
                <h2 className="text-4xl md:text-5xl font-bold text-[#002b49] mb-8">
                  Tissue Sense<br />Technology
                </h2>
                
                <p className="text-lg text-gray-700">
                  Tissue Sense technology constantly monitors signals at the instrument jaw and intelligently adjusting power for optimal sealing, fast transecting and minimized heat generation.
                </p>
              </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-semibold text-center mb-2">7mm Vessel Sealing</h3>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-semibold text-center mb-2">RF & Ultrasonic<br />Duo-energy Platform</h3>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-semibold text-center mb-2">7" Touch Screen</h3>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-semibold text-center mb-2">Multi-lingual Interface</h3>
              </div>
            </div>
