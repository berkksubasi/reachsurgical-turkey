        ...
        <section className="h-screen flex flex-col items-center justify-center sticky top-0 z-10 bg-white">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-[#002b49] mb-4">
              Enerseal Vessel Sealer/Divider
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-16">
              Advanced Vessel Sealing Technology
            </p>
            ...
            <div className="mt-12">
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                Designed for precise vessel sealing and tissue division with minimal thermal spread, 
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="w-full md:w-1/2 md:pr-12 mb-12 md:mb-0">
                <h2 className="text-4xl md:text-5xl font-bold text-[#002b49] mb-8">
                  Anti-sticking<br />Technology
                </h2>
                
                <p className="text-lg text-gray-700">
                  Our proprietary anti-sticking coating minimizes sticking, reduces eschar buildup, 
                  and simplifies cleaning during procedures, ensuring a smoother and more efficient experience.
                </p>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row-reverse items-center">
              <div className="w-full md:w-1/2 md:pl-12 mb-12 md:mb-0">
                <h2 className="text-4xl md:text-5xl font-bold text-[#002b49] mb-8">
                  Precision<br />Sealing
                </h2>
                
                <p className="text-lg text-gray-700">
                  Advanced energy delivery system provides consistent vessel sealing with minimal thermal spread.
                  Ideal for delicate procedures where precision is paramount.
                </p>
