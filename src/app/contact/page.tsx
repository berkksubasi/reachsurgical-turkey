  ...
  return (
    ...
    <div className="flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 p-8 md:p-16 bg-white">
        <h1 className="text-4xl font-bold text-[#0a3b5c] mb-8">Contact Us</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <p className="block text-sm font-medium text-gray-700 mb-2">What are you interested in: *</p>
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="ultrasonicSurgery" className="ml-2 block text-sm text-gray-700">
                  Ultrasonic Surgery Generators & Shears
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            <label htmlFor="message" className="block text-sm font-medium text-gray-700">Leave a message *</label>
            <textarea
              id="message"
              name="message"
